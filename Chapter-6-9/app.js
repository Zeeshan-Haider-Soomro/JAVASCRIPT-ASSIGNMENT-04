...
document.write(`<table><tr><th>Subject</th><th>Total Marks</th><th>Obtained Marks</th><th>Percentage</th></tr><tr><td> ${sub1} </td>
<td> ${totalMarks} </td><td> ${ob1} </td><td> ${per1}% </td></tr><tr><td> ${sub2} </td><td> ${totalMarks} </td><td> ${ob2} </td>
<td> ${per2}% </td></tr><tr><td> ${sub3} </td><td> ${totalMarks} </td><td> ${ob3} </td><td> ${per3}% </td></tr><tr><th></th><th>300</th>
<th> ${ob1 + ob2 + ob3} </th><th> ${finalper} </th></tr></table>`);
